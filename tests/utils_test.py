...
from core import validate_value, validate_get_response, BadRequestResponseException,AuthenticationRequiredException
...
class UtilsTest(unittest.TestCase):
    ...
    def test_response_400(self):
        ...
        self.assertRaises(BadRequestResponseException,
                          validate_get_response, mock_response)
    ...
    def test_response_401(self):
        ...
        self.assertRaises(AuthenticationRequiredException,
                          validate_get_response, mock_response)
